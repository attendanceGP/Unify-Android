...
public class FavPostsListAdapter extends RecyclerView.Adapter<FavPostsListAdapter.ViewHolder> {
    ...
    FavPostsListAdapter(Context context, List<Post> posts){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new FavPostsListAdapter.ViewHolder(view);
    }


    @Override
    public void onBindViewHolder(@NonNull FavPostsListAdapter.ViewHolder holder, int position) {
        Post post = posts.get(position);
